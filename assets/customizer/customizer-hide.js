...
jQuery(document).ready(
    function () {
        ...
        $context_blog_post_taxonomy_word = taxonomy_translate.context_blog_word_translate;
        ...
        wp.customize.control(
            'context_blog_home_main_blog_enable', function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_main_blog_' + $context_blog_post_taxonomy_word).selector,
        ...
        wp.customize.control(
            'context_blog_sidebar_fullwidth_enable', function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_sidebar_fullwidth_slider_' + $context_blog_post_taxonomy_word).selector,
        ...
        wp.customize.control(
            'context_blog_footer_first_list_post', function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_footer_news1_' + $context_blog_post_taxonomy_word).selector,
        ...
        wp.customize.control(
            'context_blog_footer_second_list_post', function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_footer_news2_' + $context_blog_post_taxonomy_word).selector,
        ...
        wp.customize.control(
            'context_blog_card_slider_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_card_slider_' + $context_blog_post_taxonomy_word).selector,
                ...
                jQuery('#customize-control-context_blog_card_slider_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_fullscreen_slider_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_fullscreen_slider_' + $context_blog_post_taxonomy_word).selector,
                ];
                ...
                jQuery('#customize-control-context_blog_fullscreen_slider_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_gallery_slider_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_gallery_slider_' + $context_blog_post_taxonomy_word).selector,
                ];
                ...
                jQuery('#customize-control-context_blog_gallery_slider_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_leaflet_slider_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_leaflet_slider_' + $context_blog_post_taxonomy_word).selector,
                ];
                ...
                jQuery('#customize-control-context_blog_leaflet_slider_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
                context_blog_customizer_hide(controlValueId, control, controlContainerSelectorArray);
        ...
        wp.customize.control(
            'context_blog_main_blog_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                jQuery('#customize-control-context_blog_main_blog_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_sidebar_fullwidth_slider_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                jQuery('#customize-control-context_blog_sidebar_fullwidth_slider_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_footer_news1_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                jQuery('#customize-control-context_blog_footer_news1_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_footer_news2_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                jQuery('#customize-control-context_blog_footer_news2_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
        ...
        wp.customize.control(
            'context_blog_singlepage_' + $context_blog_post_taxonomy_meta, function (control) {
                ...
                var controlContainerSelectorArray = [
                    ...
                    wp.customize.control('context_blog_singlepage_' + $context_blog_post_taxonomy_word).selector,
                ...
                jQuery('#customize-control-context_blog_singlepage_' + $context_blog_post_taxonomy_word).css("margin-left", "20px");
