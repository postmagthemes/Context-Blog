...
var RepeaterRow = function ( rowIndex, container, label ) {
    ...
    this.container.on(
        'click', '.repeater-row-remove', function () {
            self.remove();
        }
    );
    ...
    this.container.on(
        'keyup change', 'input, select, textarea', function ( e ) {
...
wp.customize.controlConstructor.repeater = wp.customize.Control.extend(
    {
        ready: function () {
            ...
            this.container.on(
                'click', 'button.repeater-add', function ( e ) {
                    e.preventDefault();
            ...
            this.container.on(
                'click', '.repeater-row-remove', function ( e ) {
            ...
            this.container.on(
                'click keypress', '.repeater-field-image .upload-button,.repeater-field-cropped_image .upload-button,.repeater-field-upload .upload-button', function ( e ) {
                    e.preventDefault();
            ...
            this.container.on(
                'click keypress', '.repeater-field-image .remove-button,.repeater-field-cropped_image .remove-button', function ( e ) {
                    e.preventDefault();
                    control.$thisButton = jQuery(this);
            ...
            this.container.on(
                'click keypress', '.repeater-field-upload .remove-button', function ( e ) {
                    e.preventDefault();
                    control.$thisButton = jQuery(this);
            ...
            if (settingValue.length ) {
                _.each(
                    settingValue, function ( subValue ) {
        ...
        removeImage: function ( event ) {
            ...
            $targetDiv.find('.kirki-image-attachment').slideUp(
                'fast', function () {
        ...
        removeFile: function ( event ) {
            ...
            $targetDiv.find('.kirki-file-attachment').slideUp(
                'fast', function () {
                    jQuery(this).show().html(jQuery(this).data('placeholder'));
                }
            );
        ...
        setValue: function ( newValue, refresh, filtering ) {
            ...
            if (filtering ) {
                jQuery.each(
                    this.params.fields, function ( index, value ) {
                ...
                jQuery.each(
                    newValue, function ( index, value ) {
                        jQuery.each(
                            filter, function ( ind, field ) {
        ...
        addRow: function ( data ) {
            ...
            if (template ) {
                ...
                newRow.container.on(
                    'row:remove', function ( e, rowIndex ) {
                        control.deleteRow(rowIndex);
                    }
                );

                newRow.container.on(
                    'row:update', function ( e, rowIndex, fieldName, element ) {
        ...
        sort: function () {
            ...
            jQuery.each(
                newOrder, function ( newPosition, oldPosition ) {
...
jQuery(document).ready(
    function ($) {
        ...
        $(document).on(
            'click', '.font-group li', function (event) {
        ...
        $(document).on(
            'keyup', 'input[type="font"]', function () {
                var value = $(this).val();
                var matcher = new RegExp(value, 'gi');
                $(this).next('.font-awesome-list').children('.font-group').children('li').show().not(
                    function () {
