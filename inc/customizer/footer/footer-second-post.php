...
$wp_customize->add_section(
	'context_blog_second_footer_post_settings',
	array(
		'panel'    => 'context_blog_footer_section_panel',
		'title'    => __( 'Second post section', 'context-blog' ),
		'priority' => 3,
	)
);

$wp_customize->add_setting(
	'context_blog_image_fnews2',
	array(
		'default'           => '',
...
$wp_customize->add_control(
	...
	array(
		'type'        => 'Image',
		'section'     => 'context_blog_second_footer_post_settings',
		'input_attrs' => array(
...
$wp_customize->add_setting(
	'context_blog_footer_second_list_post',
	array(
		'default'           => 1,
...
$wp_customize->add_setting(
	'context_blog_footer_news2_title',
	array(
		'default'           => '',
...
$wp_customize->add_control(
	...
	array(
		...
		'section'  => 'context_blog_second_footer_post_settings',
		'type'     => 'text',
		'settings' => 'context_blog_footer_news2_title',
	)
);

$wp_customize->add_setting(
	'context_blog_footer_news2_order',
	array(
...
$wp_customize->add_setting(
	'context_blog_footer_news2_category_name',
	array(
		'default'           => 0,
		'sanitize_callback' => 'sanitize_text_field',
	)
...
$wp_customize->add_setting(
	'context_blog_footer_news2_number',
	array(
		'default'           => 3,
